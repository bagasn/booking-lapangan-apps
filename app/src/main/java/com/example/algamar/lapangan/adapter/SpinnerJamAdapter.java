...
public class SpinnerJamAdapter extends ArrayAdapter<JSONObject> {

    private static final String TAG = "SpinnerJamAdapter";

    private static final int LAYOUT_RESOURCE = R.layout.row_spinner_item;

    public SpinnerJamAdapter(@NonNull Context context, @NonNull List<JSONObject> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        try {
            ...
            String title = json.getString("waktu");
